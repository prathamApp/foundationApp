...
public class QA_Adapter extends RecyclerView.Adapter<QA_Adapter.ViewHolder> {
    ...
    public QA_Adapter(List messages, Context context) {
    ...
    @Override
    public QA_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 1) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ReadingVocabularyActivity.playChat(""+((Message)messageList.get(holder.getAdapterPosition())).getSenderAudio());
            }
        });
    }
