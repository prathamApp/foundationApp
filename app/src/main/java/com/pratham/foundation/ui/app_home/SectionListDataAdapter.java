    ...
    public SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == 1) {
            if (!FC_Constants.TAB_LAYOUT)
                v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.content_item_folder_card, null);
            else
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, int i) {
        ...
        if (singleItem.getNodeType() != null) {
            if (singleItem.getNodeType().equalsIgnoreCase(TYPE_HEADER)) {
                ...
                requestOptions.placeholder(R.drawable.app_logo_r);
                ...
                if ((singleItem.getIsDownloaded().equalsIgnoreCase("true") ||
                    ...
                    try {
                        ...
                        if (singleItem.isOnSDCard()) {
                            ...
                            if (f.exists()) {
                                ...
                                holder.itemImage.setImageResource(R.drawable.warning);
                        } else {
                    ...
                    holder.actionBtn.setImageResource(R.drawable.ic_joystick);
