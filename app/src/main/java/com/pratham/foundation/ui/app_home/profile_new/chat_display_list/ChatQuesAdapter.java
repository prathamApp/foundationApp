...
public class ChatQuesAdapter extends RecyclerView.Adapter {
    ...
    public ChatQuesAdapter(Context mContext, List<Score> scoreList,
                           ChatQuesContract.ChatQuesItemClicked chatQuesItemClicked) {
...
//            tv_view = view.findViewById(R.id.tv_view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        try {
            ...
            ChatQuesAdapter.FileHolder holder = (ChatQuesAdapter.FileHolder) viewHolder;
            ...
            holder.certi_root.setOnClickListener(v -> chatQuesItemClicked.gotoQuestions(scoreList.get(position)));
