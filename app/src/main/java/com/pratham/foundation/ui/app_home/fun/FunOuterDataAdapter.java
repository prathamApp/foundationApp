...
public class FunOuterDataAdapter extends RecyclerView.Adapter {
...
//    FunContract.FunItemClicked fragmentItemClicked;
    FragmentItemClicked fragmentItemClicked;

    public FunOuterDataAdapter(Context context, List<ContentTable> dataList,
                               FragmentItemClicked fragmentItemClicked) {
//                               FunContract.FunItemClicked fragmentItemClicked) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        switch (viewHolder.getItemViewType()) {
            ...
            case 2:
                ...
                itemRowHolder.setOuterItem(dataList.get(i),i,sec_Fun);
...
//                    } else {
//                        int size = dataList.get(i).getNodelist().size() - 1;
//                        int sizeRes = dataList.get(i).getNodelist().size() - 2;
//                        itemRowHolder.btnMore.setText("SEE ALL " + sizeRes);
//                        itemRowHolder.btnMore.setVisibility(View.GONE);
//                        if (size > 6) {
...
//                    FunInnerDataAdapter learningInnerDataAdapter = new FunInnerDataAdapter(mContext, sublistList, fragmentItemClicked, i,sectionName);
