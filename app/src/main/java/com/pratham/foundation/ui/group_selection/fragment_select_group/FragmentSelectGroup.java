...
import com.pratham.foundation.ui.group_selection.fragment_child_attendance.FragmentChildAttendance;
import com.pratham.foundation.ui.group_selection.fragment_child_attendance.FragmentChildAttendance_;
...
import static com.pratham.foundation.ui.group_selection.SelectGroupActivity.grpResumeCounter;
...
//            groupAdapter.updateGroupItems(groups);
    ...
    public void setNext(View v) {
        ...
        if (groupSelected != null) {
            ...
            ArrayList<Student> students = new ArrayList<>(AppDatabase.getDatabaseInstance(context).getStudentDao().
                    getGroupwiseStudents(groupSelected.getGroupId()));
            ...
            FC_Utility.showFragment(getActivity(), new FragmentChildAttendance_(), R.id.frame_group_frg,
