package com.pratham.foundation.customView.showcaseviewlib;
...
class GuideMessageView extends LinearLayout {
    ...
    private SansTextViewBold mTitleTextView;
    private SansTextView mContentTextView;
    ...
    GuideMessageView(Context context) {
        ...
        mTitleTextView = new SansTextViewBold(context);
        ...
        mTitleTextView.setTextColor(context.getResources().getColor(R.color.dark_blue));
        addView(mTitleTextView, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));

        mContentTextView = new SansTextView(context);
        mContentTextView.setTextColor(context.getResources().getColor(R.color.dark_blue));
        mContentTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 17);
