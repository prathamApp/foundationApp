package com.pratham.foundation.customView.MorphingView;
...
public class MorphFabToDialog extends ChangeBounds {
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_CORNER_RADIUS, view.getResources().getDimensionPixelSize(R.dimen._10sdp));
    }
